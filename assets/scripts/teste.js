...
const EventNewCards = document.querySelector('#card-area').onclick = function (event){
   if(event.target.classList.contains('close')){
      event.target.parentElement.parentElement.remove()
   }
   if(event.target.classList.contains('favorite')){
      event.target.classList.add('favorited')
      const $favoriteSection = document.getElementById('favorite-area')
...
const EventFavoriteCards = document.querySelector('#favorite-area').onclick = function (event){
   if(event.target.classList.contains('close')){
      event.target.parentElement.parentElement.remove()
   }
...
function CreateCardPerson(name, img, status, specie, gender,ep){
   ...
   card.innerHTML = (`
         ...
         <div class="buttons">
            <button class=" material-symbols-outlined close" translate="no">delete</button>
            <button class="material-symbols-outlined favorite" translate="no">favorite</button>
         </div>
         `
   )
   const $section = document.getElementById('card-area')
...
const favoriteRadio = document.getElementById('favorite').onchange = ()=>{
      const $searchSection = document.getElementById('card-area')
      const $favoriteSection = document.getElementById('favorite-area')
      $favoriteSection.classList.toggle('Invi')
      $searchSection.classList.toggle('Invi')
}
const SearchRadio = document.getElementById('search-radio').onchange = ()=>{
      const $searchSection = document.getElementById('card-area')
      const $favoriteSection = document.getElementById('favorite-area')
      $favoriteSection.classList.toggle('Invi')
      $searchSection.classList.toggle('Invi')
